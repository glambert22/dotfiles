...
- `adr-compliance-reviewer`: Verifies code adheres to SunStrong's Architecture Decision Records (ADRs)
...
```
Review the following code for compliance with SunStrong's Architecture Decision Records (ADRs):
